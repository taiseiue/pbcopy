...
```bash
sudo -v
curl "https://raw.githubusercontent.com/taiseiue/pbcopy/refs/heads/main/src/pbcopy"  | sudo tee /usr/local/bin/pbcopy  >/dev/null
curl "https://raw.githubusercontent.com/taiseiue/pbcopy/refs/heads/main/src/pbpaste" | sudo tee /usr/local/bin/pbpaste >/dev/null
